...
const usersValidations = {
    editValidations: [
        ...
        body('cuit')
            ...
            .isInt({min: 11}).withMessage('Debes ingresar su CUIT').bail()
        
        ,
        body('phone')
            .notEmpty().withMessage('Debes completar el campo Telefono').bail()
            .isInt({min: 8}).withMessage('Debes ingresar un numero de telefono').bail()
        ...
        body('cp')
            ...
            .isInt({min: 4}).withMessage('Ingrese un Código Postal').bail()
